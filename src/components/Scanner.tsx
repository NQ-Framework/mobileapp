...
const Scanner: React.FC<ScannerProps> = (props: ScannerProps) => {
    ...
    useEffect(() => {
        ...
        const qrScanner = new QrScanner(element as HTMLVideoElement, (result: QrScanner.ScanResult) => {
            successCb(result.data, null);
        }, { preferredCamera: camera.id, highlightScanRegion: true, maxScansPerSecond: 25 });
